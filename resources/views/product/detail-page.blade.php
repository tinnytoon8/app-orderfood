        ...
        <div class="flex items-center justify-between">
            ...
            >
                <img
                    ...
                    alt="Sold"
                />
                <span class="text-sm font-semibold">{{ $menu->total_sold ?? 0 }} Terjual</span>
            </div>
            <div
                class="{{ $menu->percent ? "block" : "invisible" }} relative flex items-center justify-center gap-1.5 rounded-full bg-cover px-2 py-1.5"
            >
                <img
            ...
            <div class="flex w-full items-start justify-between">
                ...
                >
                    ...
                    <div>
                        <span class="block">
                            RP
                            {{ $menu->price_afterdiscount ? number_format($menu->price_afterdiscount, 0, ",", ".") : number_format($menu->price, 0, ",", ".") }}
                        </span>
                        @if ($menu->is_promo)
                            <span
